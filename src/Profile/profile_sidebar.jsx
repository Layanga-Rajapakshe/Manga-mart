  ...
  return (
    <div className="bg-gray-800 text-white w-64 h-screen flex flex-col">
      ...
      <div className="py-4 px-6 bg-gray-900">
        <h1 className="text-2xl font-bold flex items-center"><CgProfile className='mr-4 md:text-5xl' /><span className="hidden md:inline">Username</span></h1>
      </div>
      ...
      <div className="flex-1 flex items-start">
        <ul className="py-4 w-full">
          ...
          <SidebarLink to='/orders' icon={<BsBoxSeam className="mr-2 text-2xl md:text-xl" />} text="Orders" />
