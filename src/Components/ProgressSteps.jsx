      ...
      <div className='mx-20'>
        ...
        <div className="after:mt-4 after:block after:h-1 after:w-full after:rounded-lg after:bg-gray-200">
            ...
            <li className="relative flex justify-start text-blue-600">
                <div className={`${step1 ? "text-blue-600":"text-gray-500"}`}>
                    <span className="absolute -bottom-[1.75rem] start-0 text-white">
                        <div className={`${step1 ? "bg-blue-600 rounded-full":"bg-gray-600 rounded-full"}`}>
                        <svg
                        className="h-5 w-5"
            ...
            <li className="relative flex justify-center text-blue-600">
                <div className={`${step2 ? "text-blue-600":"text-gray-500"}`}>
                <span
                className="absolute -bottom-[1.75rem] left-1/2 -translate-x-1/2 rounded-full bg-blue-600 text-white"
                >
                <div className={`${step2 ? "bg-blue-600 rounded-full":"bg-gray-600 rounded-full"}`}>
                <svg
                    className="h-5 w-5"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 20 20"
            ...
            <li className="relative flex justify-end">
                <div className={`${step3 ? "text-blue-600":"text-gray-500"}`}>
                    <span className="absolute -bottom-[1.75rem] end-0 rounded-full bg-gray-600 text-white">
                        <div className={`${step3 ? "bg-blue-600 rounded-full":"bg-gray-600 rounded-full"}`}>
                            <svg
                                className="h-5 w-5"
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 20 20"
